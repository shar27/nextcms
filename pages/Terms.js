  ...
  return (
    <div>
      ...
      <div className="text-center p-10 leading-10">
        ...
        conditions of your use of the webdesignhighwycombe.co.uk website
        ...
        "we", "us" or "our"). By accessing and using the Website and Services,
        ...
        the Website and Services. You acknowledge that this Agreement is a
        ...
        and Services.
        <h2 className="text-3xl font-bold">LINKS TO OTHER RESOURCES</h2>
        ...
        amount greater of one pound or any amounts actually paid in cash by you
        ...
        <h2 className="text-3xl font-bold">INDEMNIFICATION</h2>
        ...
        part.
        <h2 className="text-3xl font-bold">SEVERABILITY</h2>
        ...
        procedural laws of the United Kingdom without regard to its rules on
        conflicts or choice of law and, to the extent applicable, the laws of
        the United Kingdom. The exclusive jurisdiction and venue for actions
        related to the subject matter hereof shall be the courts located in the
        United Kingdom, and you hereby submit to the personal jurisdiction of
        ...
        <h2 className="text-3xl font-bold">CHANGES AND AMENDMENTS</h2>
        ...
        consent to such changes. This policy was created with WebsitePolicies.
        <h2 className="text-3xl font-bold">ACCEPTANCE OF THESE TERMS</h2>
        ...
        so via the{" "}
        <Link className="text-blue-700 cursor-pointer" href="/#contactform">
          contact
        </Link>{" "}
        form or send an email to{" "}
        <Link
          className="text-blue-700 cursor-pointer"
          href="mailto:hello@webdesignhighwycombe.co.uk"
        >
