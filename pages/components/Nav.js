...
function Nav() {
  return (
    <nav className='flex justify-around z-50 absolute text-black bg-white w-full'>
        <ul className='flex justify-around gap-10 text-2xl  font-bold cursor-pointer '>
            <li className='list-none mt-10'><a>Home</a></li>
            <li className='list-none mt-10'><a href='#about'>About</a></li>
